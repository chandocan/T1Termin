...
class ConversorTexto:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('deseja remover o arquivo ao sair se sim isso remove o arquivo arquivotxt2 criar outro com outra imagem', font=fonte,size=(85,1)),sg.Button('Removendo',key='sim_3',font=fonte2,size=(8,1))],
            [sg.Button('carregaIMG.png',key='imgq'),sg.Button('Ler Arquivo_OffLine',key='-3-',font=fonte),sg.Button('Stop',key= 'stop')],
