...
class ConversorTexto:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Button('ok'      ,font=fonte),sg.Button('Ler Arquivo',font=fonte),sg.Button('Stop',key= 'Enter1')],
            [sg.Output(size=(100,5)),sg.Button('Busca Arquivo',font=fonte),sg.Text('Busque seu arquivotxt2 p/ser exibido',font=9),sg.Button('salva')],
    ...
    def falador(self):
        ...
        def apresentaMenu():
            print('escolha o arquivo digite o nome completo digite sair paran encerra se estiver em um terminal digite o nome completo do arquivo para pode ler')
        ...
        while True:
            ...
            if arquivo_selecao == 'sair': # usar com terminal
                limpar_terminal()
                exit()
            else:
                try:
                    ...
                    print('Você pode muda o nome desse arquivo clicando com o botão direito do mouse nele para salva em seu PC de outro nome a ele nãoe esquesa de colocar no final a estenção "txt", O Narrador\
                         so vai ler o arquivo que tenha o nome arquivotext2.txt se você quer reler um arquivo nasta renomealo para arquivotext2.txt' )
    ...
    def inicial(self):
        while True:
           ...
           # extraindo dados
            ...
            #EnterX = str(self.values['Enter1']).lower() # enter
